...
export default function MultiChoiceQuestion({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 h-full">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-4 md:p-6 border-2 md:border-4 border-gray-200">
                ...
                {question.image && (
                    <div className="mb-4 md:mb-6">
                        <div className="relative w-full h-64 md:h-96 rounded-2xl overflow-hidden border-2 md:border-4 border-gray-300">
                            <Image
                                src={question.image}
                                alt={question.title}
                                fill
                ...
                <div className="bg-blue-50 border-2 md:border-4 border-blue-300 rounded-2xl p-4 md:p-6">
                    <p className="text-xl md:text-2xl font-bold text-blue-800 text-center">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-4 md:p-6 border-2 md:border-4 border-gray-200 overflow-y-auto">
                    ...
                    {question.options?.map((option) => {
                        ...
                        return (
                            <button
                                ...
                                className={`border-2 md:border-4 rounded-xl md:rounded-2xl p-2 md:p-4 transition-all hover:scale-105 active:scale-95 ${isSelected
                                    ? 'bg-green-200 border-green-600 ring-2 md:ring-4 ring-green-300'
                                    : 'bg-blue-100 hover:bg-blue-200 border-blue-400'
                                    }`}
                            >
                                <div className="relative w-full h-24 md:h-40 rounded-lg md:rounded-xl overflow-hidden mb-2">
                                    <Image
                                        src={option.image}
                                        alt={option.label}
                                        fill
                                ...
                                <div className="text-lg md:text-2xl font-bold text-gray-800 text-center flex items-center justify-center gap-2">
                                    {isSelected && <span className="text-green-600 text-xl md:text-3xl">✓</span>}
