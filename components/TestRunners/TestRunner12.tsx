...
/**
 * TestRunner for Question 12: Draw Pattern
 * User draws patterns to complete sequences
 */
export default function TestRunner12({ question, onNext, currentAnswer, viewTimer }: TestRunner12Props) {
