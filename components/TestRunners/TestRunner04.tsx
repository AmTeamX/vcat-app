...
/**
 * TestRunner for Question 4: Cancellation Task
 * User crosses out shapes - examiner scores performance
 */
export default function TestRunner04({ question, onNext, currentAnswer, viewTimer, onStartTimer }: TestRunner04Props) {
    ...
    const handleStartTimer = () => {
        ...
        onStartTimer?.(); // Notify parent to start the timer
    };
                        ...
                        {!isTimerStarted ? (
                            <div className="flex items-center justify-center">
                                <button
                                    ...
                                    className="px-6 py-4 md:px-8 md:py-4 text-xl md:text-3xl font-bold rounded-xl md:rounded-2xl bg-green-500 hover:bg-green-600 text-white transition-all hover:scale-105 active:scale-95 shadow-lg"
                                >
                                    ▶️ เริ่มจับเวลา
                                </button>
                            </div>
