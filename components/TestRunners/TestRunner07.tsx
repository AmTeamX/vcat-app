...
/**
 * TestRunner for Question 7: Name Pictures
 * User names 3 pictures - examiner scores (1 point per correct name)
 */
export default function TestRunner07({ question, onNext, currentAnswer, viewTimer }: TestRunner07Props) {
