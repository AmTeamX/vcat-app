...
/**
 * TestRunner for Question 8: Name Vegetables
 * User names as many vegetables as possible in 60 seconds
 */
export default function TestRunner08({ question, onNext, currentAnswer, viewTimer, onStartTimer }: TestRunner08Props) {
                ...
                <div className="bg-white flex items-center justify-center">
                    <div className=" p-4 md:p-6 w-full max-w-2xl">
                        {!isTimerStarted ? (
                            ...
                            <div className="text-5xl md:text-7xl font-bold text-purple-600 text-center">
                                ⏱️ {viewTimer}s
                            </div>
                        ) : (
                            <div className="flex items-center justify-center">
